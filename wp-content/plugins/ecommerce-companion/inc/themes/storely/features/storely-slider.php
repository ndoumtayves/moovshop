...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class storely_slider__section_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_slider_section_premium up-to-pro" href="https://sellerthemes.com/storely-premium/" target="_blank" style="display: none;"><?php _e('More Slides Available in the Premium Version','ecommerce-companion'); ?></a>
